...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(
                __('Edit Template Item'),
                ['action' => 'edit', $templateItem->id],
                ['class' => 'side-nav-item']
            ) ?>

            <?= $this->Form->postLink(
                __('Delete Template Item'),
        ...
        <div class="templateItem view content">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($templateItem->checklist_template): ?>
                            <?= $this->Html->link(
                                h($templateItem->checklist_template->name),
                                ['controller' => 'ChecklistTemplate', 'action' => 'view', $templateItem->checklist_template->id]
                            ) ?>
                        <?php endif; ?>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($templateItem->item_master): ?>
                            <?= $this->Html->link(
                                h($templateItem->item_master->name ?? $templateItem->item_master->title ?? '[sem nome]'),
                                ['controller' => 'ItemMaster', 'action' => 'view', $templateItem->item_master->id]
                            ) ?>
                        <?php endif; ?>
                    </td>
                </tr>
            ...
            <div class="text">
                <strong><?= __('Rigor Técnico') ?></strong>
                <blockquote>
            ...
            <div class="text">
                <strong><?= __('Ação Imediata') ?></strong>
                <blockquote>
            ...
            <!-- RELACIONAMENTO: INSPECTION ITEMS -->
            <div class="related">
                <h4><?= __('Related Inspection Items') ?></h4>
                            ...
                            <?php foreach ($templateItem->inspection_item as $inspectionItem): ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        <?= $this->Html->link(
                                            __('View'),
                                            ['controller' => 'InspectionItem', 'action' => 'view', $inspectionItem->id]
                                        ) ?>

                                        <?= $this->Html->link(
                                            __('Edit'),
                                            ['controller' => 'InspectionItem', 'action' => 'edit', $inspectionItem->id]
                                        ) ?>
