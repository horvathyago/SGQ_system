 ...
 * @var string[]|\Cake\Collection\CollectionInterface $templateItems
 * @var string[]|\Cake\Collection\CollectionInterface $calibrationRecords
 */
?>
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete # {0}?', $inspectionItem->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="inspectionItem form content">
            ...
            <fieldset>
                <legend><?= __('Edit Inspection Item') ?></legend>
                <?php
